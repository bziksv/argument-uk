...
<?$APPLICATION->IncludeComponent("bitrix:menu", "f_menu", Array(
	...
	false
								...
								<div style="border-top: 1px solid #ccdae9; margin-top: 10px; padding-top: 10px; color: #ccdae9; font-size: .875rem;">Мы используем файлы <a target="_blank" style="color: #ccdae9; text-decoration: underline;" href="/upload/cookies-argument-uk.pdf">cookies</a> для персонализации рекламы и анализа трафика. Продолжая работу с сайтом, вы даёте согласие на обработку персональных данных и подтверждаете, что ознакомлены с нашей <a style="color: #ccdae9; text-decoration: underline;" target="_blank" href="/upload/politics-argument-uk.pdf">политикой конфиденциальности</a> и <a style="color: #ccdae9; text-decoration: underline;" target="_blank" href="/upload/rules-recommendation-argument-uk.pdf">правилами использования рекомендательных технологий</a>. Вы можете отключить cookies в настройках браузера.</div>
							</div>
						</div>
					</div>
				</footer>